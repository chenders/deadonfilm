 ...
 *
 * This script queues Trakt stats fetch jobs for all content with IMDb IDs.
...
const program = new Command()
  ...
  .description("Queue Trakt stats fetch jobs for movies and shows")
...
async function run(options: BackfillOptions) {
  ...
  try {
    console.log("📺 Trakt Ratings Backfill - Job Queue Version")
