...
describe("DeathEnrichmentOrchestrator", () => {
  describe("DEFAULT_CONFIG", () => {
    ...
    it("enables Claude cleanup by default", () => {
      expect(DEFAULT_CONFIG.claudeCleanup?.enabled).toBe(true)
    })

    it("enables gatherAllSources by default", () => {
      expect(DEFAULT_CONFIG.claudeCleanup?.gatherAllSources).toBe(true)
    })
