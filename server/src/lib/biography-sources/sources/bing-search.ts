/**
 * Bing Web Search source for biography information.
 *
 ...
 */
export class BingBiographySearch extends BiographyWebSearchBase {
  readonly name = "Bing (Bio)"
  readonly type = BiographySourceType.BING_SEARCH_BIO
      ...
      if (data.webPages?.value) {
        for (const item of data.webPages.value) {
          results.push({
            ...
            source: BiographySourceType.BING_SEARCH_BIO as unknown as DataSourceType,
