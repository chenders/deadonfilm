...
- **Documentation sync**: when adding/removing sources, changing architecture, or adding features, update `README.md`, linked docs (`docs/biography-system.md`, `docs/death-research-pipeline.md`, `docs/architecture.md`, `docs/api.md`), AND user-facing static pages (`src/pages/DataSourcesPage.tsx`, `AboutPage.tsx`, `FAQPage.tsx`, `MethodologyPage.tsx`) to keep source counts, pipeline descriptions, and feature lists accurate.
