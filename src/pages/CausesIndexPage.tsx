  ...
  if (error || !data) {
    return (
      <div className="mx-auto max-w-4xl text-center">
        <h1 className="mb-4 font-display text-3xl text-foreground">Deaths by Cause</h1>
        <p className="text-foreground-muted">
          Failed to load cause categories. Please try again later.
        </p>
      </div>
    )
  }
    ...
    <>
      ...
      <div data-testid="causes-index-page" className="mx-auto max-w-4xl">
        <div className="mb-6 text-center">
          <h1 className="mb-2 font-display text-3xl text-foreground">Deaths by Cause</h1>
          <p className="text-foreground-muted">{data.causes.length} causes of death documented</p>
        </div>
          ...
          {data.causes.map((category) => (
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                <h2 className="truncate font-medium text-foreground" title={category.cause}>
                  {category.cause}
                </h2>
