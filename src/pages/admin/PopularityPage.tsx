...
type Tab = "overview" | "top-actors" | "low-confidence" | "missing"
      ...
      <div className="space-y-8">
        ...
        <div>
          <h1 className="text-2xl font-bold text-admin-text-primary md:text-3xl">
            DOF Popularity Scores
          </h1>
          <p className="mt-2 text-admin-text-muted">
            View and analyze popularity scores for movies, shows, and actors
          </p>
        </div>
