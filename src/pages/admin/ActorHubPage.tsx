/**
 * Actor Hub page.
 * Consolidates Actor Management, Actor Diagnostic, Biographies, Data Quality,
 * and Popularity into a single tabbed view.
 */
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="mt-2 text-admin-text-muted">
            Manage actors, diagnostics, biographies, data quality, and popularity scores
          </p>
        </div>
