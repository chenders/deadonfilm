...
type Tab = "overview" | "future-deaths" | "uncertain-deaths" | "reset-enrichment"
  ...
  return (
    <AdminLayout>
      <div className="space-y-8">
        {/* Header */}
        <div>
          <h1 className="text-2xl font-bold text-admin-text-primary md:text-3xl">Data Quality</h1>
          <p className="mt-2 text-admin-text-muted">
            Identify and fix data quality issues in actor death records
          </p>
        </div>
            ...
            {overview.data && (
              <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                ...
                <div className="rounded-lg bg-admin-surface-elevated p-6 shadow-admin-sm">
                  ...
                  <button
                    onClick={() => setActiveTab("future-deaths")}
                ...
                <div className="rounded-lg bg-admin-surface-elevated p-6 shadow-admin-sm">
                  ...
                  <button
                    onClick={() => setActiveTab("uncertain-deaths")}
                    className="mt-4 text-sm font-medium text-admin-interactive hover:underline"
                  >
                    View details
                  </button>
                ...
                <div className="rounded-lg bg-admin-surface-elevated p-6 shadow-admin-sm">
                  ...
                  <button
                    onClick={() => setActiveTab("reset-enrichment")}
                    className="mt-4 text-sm font-medium text-admin-interactive hover:underline"
                  >
                    Reset enrichment
                  </button>
                  ...
                  <tbody className="divide-y divide-admin-border bg-admin-surface-elevated">
                    {futureDeaths.data.actors.map((actor) => (
                      <tr key={actor.id}>
                        ...
                        <td className="whitespace-nowrap px-6 py-4 text-sm text-admin-text-secondary">
                          {actor.popularity != null ? Number(actor.popularity).toFixed(1) : "N/A"}
                        </td>
                      </tr>
                    ))}
        ...
        {/* Uncertain Deaths Tab */}
        {activeTab === "uncertain-deaths" && (
          <div className="space-y-6">
            <div className="rounded-lg bg-admin-surface-elevated p-4 shadow-admin-sm md:p-6">
              <h3 className="text-xl font-semibold text-admin-text-primary">
                Uncertain Death Records
        ...
        {/* Reset Enrichment Tab */}
        {activeTab === "reset-enrichment" && (
          <div className="space-y-6">
            <div
                ...
                <div className="border-admin-success/50 bg-admin-success/20 mt-4 rounded-md border p-4">
                  ...
                  {resetMutation.data.dryRun && resetMutation.data.actor ? (
                    <div className="mt-2 text-sm text-admin-text-primary">
                      ...
                      <p>
                        <strong>Would delete:</strong> {resetMutation.data.actor.historyCount}{" "}
                        history entries
                      </p>
                    </div>
                  ) : (
                    <div className="mt-2 text-sm text-admin-text-primary">
                      ...
                      <p>
                        <strong>Deleted:</strong> {resetMutation.data.historyDeleted} history
                        entries, {resetMutation.data.circumstancesDeleted} circumstances record
                      </p>
                    </div>
                  )}
                </div>
