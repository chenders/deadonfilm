...
/** Thin wrapper that connects the shared ActorLogsModal to the death enrichment data hook */
function ActorLogsModalWrapper({
  runId,
  actorId,
  actorName,
  onClose,
  ...
  return (
    <ActorLogsModal
      title={`Enrichment Logs: ${actorName}`}
      subtitle={`Run #${runId} / Actor #${actorId}`}
