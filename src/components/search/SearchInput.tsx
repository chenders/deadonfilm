    ...
    return (
      <div data-testid="search-input-container" className="relative">
        <input
          ...
          className="w-full rounded-lg border-2 border-brown-medium/30 bg-surface-elevated px-3 py-2 text-base placeholder:text-text-muted/50 focus:border-brown-medium focus:outline-none focus:ring-2 focus:ring-brown-medium/20 sm:px-4 sm:py-3 sm:text-lg"
          role="combobox"
