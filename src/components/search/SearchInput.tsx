    ...
    return (
      <div data-testid="search-input-container" className="relative">
        <input
          ...
          className="w-full rounded-lg border-2 border-brown-medium/30 bg-surface-elevated py-3 pl-3 pr-10 text-base shadow-md placeholder:text-text-muted/70 focus:border-brown-medium focus:shadow-lg focus:outline-none focus:ring-4 focus:ring-brown-medium/30 md:py-4 md:pl-5 md:pr-12 md:text-lg"
          role="combobox"
