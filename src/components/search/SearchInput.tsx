    ...
    return (
      <div data-testid="search-input-container" className="relative">
        <input
          ...
          className="w-full rounded-lg border-2 border-brown-medium/30 bg-surface-elevated px-4 py-3 text-lg placeholder:text-text-muted/50 focus:border-brown-medium focus:outline-none focus:ring-2 focus:ring-brown-medium/20"
          role="combobox"
