/**
 * Death Coverage tab content.
 * Extracted from CoverageDashboardPage for use in the Analytics Hub.
 */
...
export default function CoverageTab() {
  ...
  if (!stats) {
    return <div className="py-12 text-center text-admin-text-muted">No coverage data available</div>
  }
