...
export default function CalculationExplainer({ type }: CalculationExplainerProps) {
  ...
  return (
    <div className="mt-6 rounded-lg border border-border-theme/20 bg-surface">
      <button
        onClick={() => setIsOpen(!isOpen)}
        className="flex w-full items-center justify-between px-4 py-3 text-left"
      >
        <span className="font-display text-sm text-foreground">How is this calculated?</span>
        <span className="text-foreground-muted">{isOpen ? "-" : "+"}</span>
      </button>

      {isOpen && (
        <div className="border-t border-border-theme/20 px-4 py-4 text-sm text-foreground-muted">
          {type === "movies" ? (
            <div className="space-y-4">
              <section>
                <h4 className="font-medium text-foreground">Expected Deaths</h4>
                <p>
              ...
              <section>
                <h4 className="font-medium text-foreground">Curse Score</h4>
                <p>
                  The curse score measures how much higher the actual deaths are compared to
                  expected:
                </p>
                <p className="mt-1 rounded bg-surface-muted px-2 py-1 font-mono text-xs">
              ...
              <section>
                <h4 className="font-medium text-foreground">Exclusions</h4>
                <p>
            ...
            <div className="space-y-4">
              ...
              <section>
                <h4 className="font-medium text-foreground">Minimum Movies</h4>
                <p>
